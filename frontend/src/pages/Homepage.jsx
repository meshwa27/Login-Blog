...
const Homepage = () => {
  return (
<div class="py-md-32 position-relative" style={{height:"100vh",maxWidth:"100"}}>
        ...
        <div class="col-lg-6 order-lg-1 ms-auto d-none d-lg-block">
          <div class="mb-5 mb-lg-0 w-11/10 position-relative">
            ...
            <div class="svg-fluid position-relative overlap-10">
              <svg id="ab47acfe-844d-4101-aa7b-df38aa50dbe4" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%" height="628.38145" viewBox="0 0 971.0518 628.38145">
